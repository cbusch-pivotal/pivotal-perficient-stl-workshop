...
----
+
The Gradle Wrapper will automatically download the appropriate version of Gradle for this project along with all of _Attendees_'s dependencies. This may take a few moments.
...
+
image::/../../common/images/Attendees_NS.png[]
+
