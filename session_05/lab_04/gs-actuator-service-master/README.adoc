...
session_05/lab_04/gs-actuator-service-master/initial/src/main/java/hello/HelloWorldApplication.java`
[source,java]
----
...
$ cd $HOME/session_05/lab_04/gs-actuator-service-master/initial
$ ls -al manifest.yml

Edit manifest.yml

link::pivotal-perficient-stl-workshop/session_05/lab_04/gs-actuator-service-master/initial/manifest.yml


Update the name to something unique

name: hello-world-{student9}
...
Note the route for your application: 

Replace <student9> with your uniqiue entry from the manifest file

Browse to http://hello-world-student9.cfapps.io/actuator 
http://hello-world-student9.cfapps.io/actuator/health

https://hello-world-student9.cfapps.io/hello-world

== To see other Other actuator endpoints

$ cd $HOME/lab_04/gs-actuator-service-master/initial/src/main/resources
See example here:
link::pivotal-perficient-stl-workshop/session_05/lab_04/gs-actuator-service-master/complete


Add the file - application.properties
...
Now you should be able to see additional endpoints:

http://hello-world-student9.cfapps.io/actuator 
http://hello-world-student9.cfapps.io/actuator/health
http://hello-world-student9.cfapps.io/actuator/env
http://hello-world-student9.cfapps.io/actuator/metrics

http://hello-world-student9.cfapps.io/actuator/metrics/jvm.memory.used
